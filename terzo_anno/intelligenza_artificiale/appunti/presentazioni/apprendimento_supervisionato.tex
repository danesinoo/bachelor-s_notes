...
I problemi di inserparabilità lineare (AB e AC) possono essere risolti da reti
...
In generale, i metodi per prevenire eccessivo overfitting sono chiamati metodi
di regolarizzazione.
