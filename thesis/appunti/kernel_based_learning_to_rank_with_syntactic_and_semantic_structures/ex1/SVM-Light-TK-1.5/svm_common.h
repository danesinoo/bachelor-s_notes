...
#define MAX_NUMBER_OF_CHILDREN	100		// max children in a tree
#define MAX_PARSE_TREE_LENGTH	5000		// lenght in characters of the parenthetic format
#define MAX_NUMBER_OF_NODES		800		// nodes in a tree
#define MAX_NUMBER_OF_PAIRS		15000		// number of productions or node pairs - the worst case  is MAX_NUMBER_OF_NODES^2
#define MAX_PRODUCTION_LENGTH	1000		// in characters
#define MAX_NUMBER_OF_TREES		10		// in the forest
#define MAX_STRING_LENGTH		1000		// lenght of sequences in string kernel
*/

// normal tree setting
#define FAST // faster evaluation of PT ==> static memory will be used
#define MAX_NUMBER_OF_CHILDREN_PT 130   // USED ONLY FOR FAST EVALUATION of PT, i.e. when "#define FAST"
...
/*
#define FAST // faster evaluation of PT ==> static memory will be used
#define MAX_NUMBER_OF_CHILDREN_PT 174   // USED ONLY FOR FAST EVALUATION of PT, i.e. when "#define FAST"

#define MAX_NUMBER_OF_CHILDREN	1000		// max children in a tree
#define MAX_PARSE_TREE_LENGTH	100000		// lenght in characters of the parenthetic format
#define MAX_NUMBER_OF_NODES		10000		// nodes in a tree
#define MAX_NUMBER_OF_PAIRS		50000		// number of productions or node pairs - the worst case  is MAX_NUMBER_OF_NODES^2
#define MAX_PRODUCTION_LENGTH	5000		// in characters
#define MAX_NUMBER_OF_TREES		50000		// in the forest
#define MAX_STRING_LENGTH		10000		// lenght of sequences in string kernel
*/
...
# define PERCEPTRON     4     /* train using perceptron model */
# define PERCEPTRON_BATCH     5     /* train using perceptron model in batch */
...
extern double Jeopardy_QC(KERNEL_PARM * kernel_parm, DOC * a, DOC * b);
extern double Jeopardy_QAR(KERNEL_PARM * kernel_parm, DOC * a, DOC * b);
