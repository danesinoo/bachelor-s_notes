...
import static it.unipd.pdp2022.tictactoe.Positions.*;
...
public class Game {
  ...
  /** Insieme delle combinazioni vincenti */
  ...
  /**
   * Se vero, la posizione indicata è vincente
   *
   * @param test Posizione da verificare
   * @return Vero se una posizione vincente è contenuta all'interno della posizione
   */
  ...
  /**
   * Costruttore privato, che permette di inizializzare uno stato
   *
   * @param current Giocatore corrente
   * @param playerO Caselle di O
   * @param playerX Caselle di X
   */
  ...
  public String availableMoves() {
    return Stream.of(Positions.values())
  ...
  /**
   * Ritorna il simbolo che occupa la posizione indicata
   *
